# `angular-seed-box` — the seed for AngularJS apps
...
To get you started you can simply clone the `angular-seed-box` repository and install the dependencies:

### Prerequisites

You need git to clone the `angular-seed-box` repository. You can get git from [here][git].

We also use a number of Node.js tools to initialize and test `angular-seed-box`. You must have Node.js
and its package manager (npm) installed. You can get them from [here][node].

### Clone `angular-seed-box`

Clone the `angular-seed-box` repository using git:

```
git clone https://github.com/angular/angular-seed-box.git
cd angular-seed-box
```

If you just want to start a new project without the `angular-seed-box` commit history then you can do:

```
git clone --depth=1 https://github.com/angular/angular-seed-box.git <your-project-name>
```
...
There are two kinds of tests in the `angular-seed-box` application: Unit tests and end-to-end tests.

### Running Unit Tests

The `angular-seed-box` app comes preconfigured with unit tests. These are written in [Jasmine][jasmine],
...
The `angular-seed-box` app comes with end-to-end tests, again written in [Jasmine][jasmine]. These tests
...
up-to-date. The `angular-seed-box` project is configured to do this automatically before running the
...
The `angular-seed-box` project supports loading the framework and application scripts asynchronously.
...
The `angular-seed-box` project comes preconfigured with a local development web server. It is a Node.js
...
your repository and execute scripts such as building the app or running tests. The `angular-seed-box`
